...
"[project]/apps/web/src/app/api/auth/login/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    if (!API_BASE_URL) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: "Missing API_BASE_URL env var"
        }, {
            status: 500
        });
    }
    ...
    const sessionToken = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$session$2e$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["signSession"])(String(sub), String(apiToken));
    ...
    res.cookies.set(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$session$2e$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["COOKIE_NAME"], sessionToken, (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$session$2e$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sessionCookieOptions"])());
    return res;
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__a9ea896d._.js.map